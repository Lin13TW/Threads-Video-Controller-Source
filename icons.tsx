...
export const VolumeHighIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M13.5 4.06c0-1.336-1.616-2.005-2.56-1.06l-4.5 4.5H4.508c-1.141 0-2.318 1.08-2.318 2.25v4.5c0 1.171 1.177 2.25 2.318 2.25H6.44l4.5 4.5c.945.945 2.56.276 2.56-1.06V4.06zM17.78 9.22a.75.75 0 10-1.06 1.06L18.44 12l-1.72 1.72a.75.75 0 101.06 1.06l1.72-1.72 1.72 1.72a.75.75 0 101.06-1.06L20.56 12l1.72-1.72a.75.75 0 10-1.06-1.06l-1.72 1.72-1.72-1.72z" />
  </svg>
);
...
export const SpeakerWaveIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M13.5 4.06c0-1.336-1.616-2.005-2.56-1.06l-4.5 4.5H4.508c-1.141 0-2.318 1.08-2.318 2.25v4.5c0 1.171 1.177 2.25 2.318 2.25H6.44l4.5 4.5c.945.945 2.56.276 2.56-1.06V4.06z" />
    <path d="M17.7 7.75a.75.75 0 011.06 0c2.34 2.34 2.34 6.14 0 8.49a.75.75 0 11-1.06-1.06c1.76-1.76 1.76-4.6 0-6.36a.75.75 0 010-1.07z" />
    <path d="M15.58 10.12a.75.75 0 011.06 0 1.5 1.5 0 010 2.12.75.75 0 11-1.06-1.06.75.75 0 010-1.06z" />
  </svg>
);
